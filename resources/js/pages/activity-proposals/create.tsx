...
export default function CreateActivityProposal({
    ...
    const [confirmedConflicts, setConfirmedConflicts] = useState<
        ConflictItem[]
    >([]);
    const [tentativeConflicts, setTentativeConflicts] = useState<
        ConflictItem[]
    >([]);
                    ...
                    {({ processing, errors }) => (
                        <div className="space-y-4">
                            ...
                            {calendarMode === 'on_calendar' && (
                                <div className="space-y-1">
                                    <Label htmlFor="calendar_activity_id">
                                    ...
                                    {loadingActivities ? (
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            No approved calendar activities
                                    ...
                                    <InputError
                                        message={errors.calendar_activity_id}
                                    />
                                </div>
                            )}
                            ...
                            {calendarMode !== '' && (
                                <>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        />
                                        <InputError
                                            message={errors.proposed_budget}
                                        />
                                    </div>
