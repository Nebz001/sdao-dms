...
/**
 * Fired the moment SDAO marks a self-registered student's account Rejected
 * (trigger unchanged, still RejectAccount::execute()). See
...
class AccountRejectedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return (new AccountRejectedMail($notifiable))->to($notifiable->email);
    }
