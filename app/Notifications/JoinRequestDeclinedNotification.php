...
use App\Mail\JoinRequestDeclinedMail;
 ...
 * declines their join request (App\Organizations\DeclineJoinRequest). See
 * AccountRejectedNotification's docblock for the mail/database channel split.
 */
class JoinRequestDeclinedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return (new JoinRequestDeclinedMail($this->joinRequest))->to($notifiable->email);
    }
